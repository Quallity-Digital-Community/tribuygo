...
export default class CreateStudent extends Component {
  constructor(props) {
    ...
    this.busOption = this.busOption.bind(this);
  ...
  onChangeBusNumber(e) {
    ...
    //console.log("dropdown clicked", this.state.busNumber);
  }
  validateName = () => {
  ...
  onSubmit(e) {
    ...
    axios.get('https://maps.googleapis.com/maps/api/geocode/json',{
      ...
      axios.post('http://172.105.92.110:4000/addStudent', obj)
          .then();
  ...
  handleClick(e){
    ...
    axios.post("http://localhost:4000/uploadStudent", data, { 
  ...
  busOption(){
    return this.state.busses.map(function(object, i){
            ...
            <form onSubmit={this.onSubmit}>
                <div><h6>Add New Student </h6> 
                   <div id = "studentName" > Enter Student Name : 
                    ...
                    <select id="busses" className="select form-control" value = {this.state.value} onChange = {this.onChangeBusNumber} >
                            {this.busOption()}
                    </select>
